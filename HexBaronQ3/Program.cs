...
namespace HexBaronCS
{
    class Program
    {
        ...
        public static void PlayGame(Player player1, Player player2, HexGrid grid)
        {
            ...
            do
            {
                ...
                if (gameOver)
                {
                    grid.DestroyPiecesAndCountVPs(ref player1VPsGained, ref player2VPsGained, player1, player2);
                }
                else
                    gameOver = grid.DestroyPiecesAndCountVPs(ref player1VPsGained, ref player2VPsGained, player1, player2);
    ...
    class HexGrid
    {
        ...
        public bool DestroyPiecesAndCountVPs(ref int player1VPs, ref int player2VPs, Player Player1, Player Player2)
        {
