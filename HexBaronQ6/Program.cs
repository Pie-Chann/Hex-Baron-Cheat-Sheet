            ...
            do
            {
                ...
                foreach (var c in commands)
                {
                    ...
                    else
                    {
                        ...
                        // 3rd move refund
                        bool thirdMoveRefund = false;
                        if (items[0] == "move" && consecutivesMoves == 2)
                        {
                            int startID = Convert.ToInt32(items[1]);
                            if (startID == lastEndID)
                            {
                                thirdMoveRefund = true;
                                if (player1Turn)
                                {
                        ...
                        if (summaryOfResult == "Command executed")
                        {
                            if (items[0] == "move")
                            {
                                ...
                                if (consecutivesMoves == 0 || startID == lastEndID)
                                {
                                    consecutivesMoves++;
                                    lastEndID = endID;
                                }
