            ...
            do
            {
                ...
                foreach (var c in commands)
                {
                    ...
                    else
                    {
                        ...
                        fuelCount += fuelChange;
                        if (fuelCount == 3)
                        {
                            grid.MakeField(Convert.ToInt32(items[1]));
    ...
    class HexGrid
    {
        ...
        private bool ExecuteCommandInTile(List<string> items, ref int fuel, ref int lumber)
        {
            ...
            if (thePiece.HasMethod(items[0]))
            {
                ...
                {
                    int addFuel = Convert.ToInt32(method.Invoke(thePiece, parameters));
                    if (addFuel != 0)
                    {
                        fuel += 1;
                    }
        ...
        public void MakeField(int tileToUse)
        {
